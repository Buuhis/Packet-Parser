...
int main(int argc, char *argv[]) {
    ...
    byte *server_pub = (byte*)malloc(PQC_BUFF_MAX);
    byte *server_priv = (byte*)malloc(PQC_BUFF_MAX);
    ...
    byte cipher_capsule[PQC_BUFF_MAX], s1_shared_secret[64], s2_shared_secret[64];
    int capsule_sz = 0;
