...
unsigned int mwan_l2_idle_min_pct = 10;
unsigned int mwan_l2_idle_recover_pct = 30;
...
module_param_named(l2_cpu_idle_min, mwan_l2_idle_min_pct, uint, 0644);
MODULE_PARM_DESC(l2_cpu_idle_min,
                 "Minimum idle percent required for new-flow admission");
module_param_named(l2_cpu_idle_recover, mwan_l2_idle_recover_pct, uint, 0644);
MODULE_PARM_DESC(l2_cpu_idle_recover,
                 "Idle percent required for three samples before unblocking");
module_param_named(l2_softirq_sample_ms, mwan_l2_softirq_sample_ms, uint,
                   0644);
MODULE_PARM_DESC(l2_softirq_sample_ms,
                 "Per-CPU total accounting sample interval in milliseconds");
