...
INSERT INTO public.nodes (node_id, role, local_if, remote_cidr)
VALUES (
    1, 'server', 'enp7s0', '192.168.182.0/24'
);

INSERT INTO public.ne_tunnels (node_id, name, ifname, gateway, port, weight)
VALUES 
    (1, 'ne_tunnel1', 'ne_tunnel1', '172.16.23.2', 65001, 1),
    (1, 'ne_tunnel2', 'ne_tunnel2', '172.16.25.2', 65002, 1);

INSERT INTO public.nodes (node_id, role, local_if, remote_cidr)
VALUES (
    2, 'server', 'enp7s0', '192.168.9.0/24'
);

INSERT INTO public.ne_tunnels (node_id, name, ifname, gateway, port, weight)
VALUES 
    (2, 'ne_tunnel1', 'ne_tunnel1', '172.16.23.1', 65001, 1),
    (2, 'ne_tunnel2', 'ne_tunnel2', '172.16.25.1', 65002, 1);
